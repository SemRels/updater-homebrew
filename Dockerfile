...
# SPDX-FileCopyrightText: 2026 The updater-homebrew Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-updater-homebrew" \
      org.opencontainers.image.description="semrel plugin: updater-homebrew" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/updater-homebrew" \
